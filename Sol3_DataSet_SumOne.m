...
save([SaveDir,num2str(SubjectNumber),'/','ErrorsAndLambdas-48_Sol3_SumOne_',sprintf('S-%g',StoppingCriterion),'.mat'],'-struct','x');
x.x=BestErrors;
save([SaveDir,num2str(SubjectNumber),'/','Errors-48_Best_Sol3_SumOne_',sprintf('S-%g',StoppingCriterion),'.mat'],'-struct','x');
sendmail(myaddress, sprintf('Sol3 -48 SumOne Subject[%02d],StoppingCriterion[%g],BestLambda[%6.3f] AvgError[%8.6f]',SubjectNumber,StoppingCriterion,BestLambda,BestAvgError));
