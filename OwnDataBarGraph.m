...
% X=1:2;
Mean=[0.28 0.23 0.27 0.26 0.26 0.22;0.34 0.32 0.31 0.31 0.29 0.27];
Std=[0.17 0.13 0.16 0.14 0.14 0.13;0.19 0.20 0.19 0.19 0.21 0.18];
...
lh = legend('SVR','LLE','LLE\_TRI','ALR','Ours','Ours-R');
...
set(h(6),'LineWidth',2.5,'EdgeColor','red');
errorbar_tick(h, 50);
hold off;
