...
%         Low_BSamples=Up_BSamples;
        ...
        % Outer contour, combined the upper parabola and the lower one
        % together since their share same paramters
        Contour_XeSamples=GenerateSmaplesBasedOnWeights( Contour_Old_XeSamples, Contour_Samples_Old_Weight./sum(Contour_Samples_Old_Weight), Resample_Sigma1, SampleAmount);
        Contour_Samples_NewWeight=double(ones(1,SampleAmount))./SampleAmount;
        ...
        Contour_BSamples=GenerateSmaplesBasedOnWeights(Contour_Old_BSamples, Contour_Samples_Old_Weight./sum(Contour_Samples_Old_Weight), Resample_Sigma4, SampleAmount);
        ...
        Iris_XcSamples=double(zeros(2,SampleAmount));
        Iris_Samples_NewWeight=double(ones(1,SampleAmount))./SampleAmount;
        Iris_XcSamples=GenerateSmaplesBasedOnWeights( Iris_Old_XcSamples, Iris_Samples_Old_Weight./sum(Iris_Samples_Old_Weight), Resample_Sigma1, SampleAmount);
        Iris_RSamples=GenerateSmaplesBasedOnWeights( Iris_Old_RSamples,Iris_Samples_Old_Weight./sum(Iris_Samples_Old_Weight), Resample_Sigma5, SampleAmount);
    end
