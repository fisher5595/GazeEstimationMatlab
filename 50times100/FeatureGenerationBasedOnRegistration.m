...
figure(1);
imshow(CroppedImage);
imwrite(CroppedImage,['enlarged_registeredEyes_left_',int2str(1),'.jpg']);
...
for QueryImageNumber=2:36
    ...
    imwrite(QueryCroppedImage,['enlarged_registeredEyes_left_',int2str(QueryImageNumber),'.jpg']);
    ...
    x.x=double(ImageVector')./255;
    save(['enlarged_RegisteredFeature_left_', int2str(QueryImageNumber-1), '.mat'],'-struct','x');
    pause;
end
