...
for SubjectNumber=9:9
    ...
    %Errors=load([SaveDir,num2str(SubjectNumber),'/','Errors_ALR', '.mat']);
    ...
    Errors=load([SaveDir,num2str(SubjectNumber),'/','Errors_Best_Sol3_SumOne_',sprintf('S-%g',StoppingCriterion),'.mat']);
    Errors=Errors.x;
